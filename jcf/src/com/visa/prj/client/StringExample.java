...
public class StringExample {
	...
	public static void main(String[] args) {
		...
		double mSum = mobileStream.map(p->p.getPrice()).reduce(0.0, (v1,v2)->v1+v2);
		System.out.println(mSum);
		System.out.println("******");
		
//		double mSumTwo = mobileStream.map(p->p.getPrice()).reduce(0.0, (v1,v2)->v1+v2);
//		System.out.println(mSumTwo);
//		System.out.println("******");
